...
import com.example.quizapplication.data.database.progress.UserProgress
...
class CachingQuizRepository(
    ...
    override suspend fun fetchAndCacheQuiz(categoryId: Int, amount: Int, difficulty: String) {
        val apiResponse = quizApiService.getQuiz(amount.toInt(), categoryId, difficulty.lowercase())
